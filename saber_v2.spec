...
"""Backend-first v2 parallel PyInstaller specification.

This does not replace ``app.spec`` until the stage-6 cutover.  It packages the
single role-dispatched executable so API import-boundary probes can run against
the same bundle that also contains Worker dependencies.
"""
...
# ===================== 隐藏导入 =====================
hiddenimports += [
    # Backend-first v2 role dispatcher and persistence
    ...
    'src.backend_v2.storage', 'src.backend_v2.storage.database',
    'src.backend_v2.storage.schema', 'src.backend_v2.storage.lifecycle',
    'src.backend_v2.storage.single_instance', 'src.backend_v2.storage.epochs',
    'src.backend_v2.storage.assets', 'src.backend_v2.storage.seeding',
    'src.backend_v2.storage.platform_repositories',
    'src.backend_v2.runtime_heartbeat', 'src.backend_v2.domain',
