...
export const FONT_SIZE_STEP = 2;  // 滑块步进值
...
export const EDIT_VIEW_MODE = {
    DUAL: 'dual',      // 双图对照
    ORIGINAL: 'original',  // 仅原图
    TRANSLATED: 'translated'  // 仅翻译图
};

// --- 重试机制默认值 ---
export const DEFAULT_TRANSLATION_MAX_RETRIES = 3;  // 普通翻译默认重试次数
export const DEFAULT_HQ_TRANSLATION_MAX_RETRIES = 2;  // 高质量翻译默认重试次数
export const DEFAULT_PROOFREADING_MAX_RETRIES = 2;  // AI校对默认重试次数
