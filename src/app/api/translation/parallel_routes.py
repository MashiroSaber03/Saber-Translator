    ...
    try:
        ...
        for bs_data in bubble_states_data:
            ...
            bubble_state = BubbleState(
                ...
                text_align=bs_data.get('textAlign', bs_data.get('text_align', 'center')),
                line_spacing=bs_data.get('lineSpacing', bs_data.get('line_spacing', 1.15)),
        ...
        for bs in updated_states:
            bubble_states_output.append({
                ...
                'textAlign': getattr(bs, 'text_align', 'center'),
                'lineSpacing': getattr(bs, 'line_spacing', 1.15),
